...
try {
  components = {
    ...
    cartList: __webpack_require__(/*! @/components/cart-list/cart-list.vue */ 91).default
  }
} catch (e) {
  if (
...
var components
try {
  components = { card4: __webpack_require__(/*! @/components/card-4/card-4.vue */ 80).default }
} catch (e) {
  if (
    e.message.indexOf("Cannot find module") !== -1 &&
    e.message.indexOf(".vue") !== -1
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _uni = _interopRequireDefault(__webpack_require__(/*! @/uni.scss */ 117));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n// console.log(uniScss)\nvar _default = { data: function data() {return { el_label: undefined, current: 0 };}, onPullDownRefresh: function onPullDownRefresh(e) {}, mounted: function mounted() {var _this = this;this.$nextTick(function () {uni.createSelectorQuery().in(_this).selectAll('.label') // .boundingClientRect(data => {\n      // \tconsole.log(data);\n      // })\n      .fields({ size: true, rect: true }, function (data) {_this.el_label = data; // console.log(this.el_label);\n      }).exec();});}, methods: {}, computed: { Variety_line: function Variety_line() {if (this.el_label == undefined) return '';var l = this.el_label[this.current].left - _uni.default.margin / 2;var w = this.el_label[this.current].width;\n      var css = \"margin-left: \".concat(l, \"px;width: \").concat(w, \"px;\");\n      return css;\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///88\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _cart_list_vue_vue_type_template_id_71c27a48___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart-list.vue?vue&type=template&id=71c27a48& */ 92);\n/* harmony import */ var _cart_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cart-list.vue?vue&type=script&lang=js& */ 94);\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _cart_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _cart_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n/* harmony import */ var _HBuilderX_3_3_5_20211229_full_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../HBuilderX.3.3.5.20211229.full/HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 8);\n\nvar renderjs\n\n\nfunction injectStyles (context) {\n  \n  if(!this.options.style){\n          this.options.style = {}\n      }\n      if(Vue.prototype.__merge_style && Vue.prototype.__$appStyle__){\n        Vue.prototype.__merge_style(Vue.prototype.__$appStyle__, this.options.style)\n      }\n      if(Vue.prototype.__merge_style){\n                Vue.prototype.__merge_style(__webpack_require__(/*! ./cart-list.vue?vue&type=style&index=0&lang=scss& */ 96).default, this.options.style)\n            }else{\n                Object.assign(this.options.style,__webpack_require__(/*! ./cart-list.vue?vue&type=style&index=0&lang=scss& */ 96).default)\n            }\n\n}\n\n/* normalize component */\n\nvar component = Object(_HBuilderX_3_3_5_20211229_full_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\n  _cart_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  _cart_list_vue_vue_type_template_id_71c27a48___WEBPACK_IMPORTED_MODULE_0__[\"render\"],\n  _cart_list_vue_vue_type_template_id_71c27a48___WEBPACK_IMPORTED_MODULE_0__[\"staticRenderFns\"],\n  false,\n  null,\n  null,\n  \"339ec83f\",\n  false,\n  _cart_list_vue_vue_type_template_id_71c27a48___WEBPACK_IMPORTED_MODULE_0__[\"components\"],\n  renderjs\n)\n\ninjectStyles.call(component)\ncomponent.options.__file = \"components/cart-list/cart-list.vue\"\n/* harmony default export */ __webpack_exports__[\"default\"] = (component.exports);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///91\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _configure = __webpack_require__(/*! @/common/configure.json */ 100);\nvar _nav = _interopRequireDefault(__webpack_require__(/*! ./components/nav.vue */ 101));\nvar _tabBar = _interopRequireDefault(__webpack_require__(/*! ./components/tabBar.vue */ 108));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { myNav: _nav.default, mytabBar: _tabBar.default }, mixins: [], data: function data() {return { current: 1, Page: _configure.tabBar };}, onLoad: function onLoad() {}, onReady: function onReady() {}, methods: { nav: function nav() {uni.navigateTo({ url: '../../pages/cart/cart' });} }, computed: {\n    swiperItem: function swiperItem() {\n\n\n\n\n      return \"width: 750rpx;transform: translateX(-\".concat(750 * this.current, \"rpx);\");\n\n    },\n    Qlayout: function Qlayout() {\n\n\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///99\n");
...
/* 117 */
/*!****************************************!*\
  !*** D:/Desktop/uniapp/Store/uni.scss ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = {\n  \"@VERSION\": 2\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbbnVsbF0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBO0FBQ0E7QUFDQSIsImZpbGUiOiIxMTcuanMiLCJzb3VyY2VzQ29udGVudCI6WyJtb2R1bGUuZXhwb3J0cyA9IHtcbiAgXCJAVkVSU0lPTlwiOiAyXG59Il0sInNvdXJjZVJvb3QiOiIifQ==\n//# sourceURL=webpack-internal:///117\n");
